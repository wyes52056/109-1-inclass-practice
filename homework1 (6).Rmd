...
Game6 <- list(Date="Oct. 11",
              ...
              Away="Miami Heat",
              Home="L.A.Lakers")
Game7 <- list(Date="Oct. 13",
              StartTime="21:00",
              TimeZone="ET",
              Away="L.A.Lakers",
              Home="Miami Heat")
NBA1920Final567 <- list(Game5=Game5,
                        Game6=Game6,
                        Game7=Game7)
print(str(NBA1920Final567))
names(NBA1920Final567)
length(NBA1920Final567)
str(NBA1920Final567, 1)
...
```{r ans13}
# G5TimeParsed
paste0(Game5Time[[1]]," ",Game5Time[[2]]," ",Game5Time[[3]])
```
...
```{r ans14}
# TpeJason
MiamiTime <- ymd_hms("2020-10-09 21:00:00", tz="EST")
TpeJason <- with_tz(MiamiTime, tzone="Asia/Taipei")
...
```{r ans15}
# ParisLouis
MiamiTime2 <- ymd_hms("2020-10-09 21:15:00", tz="EST")
ParisLouis <- with_tz(MiamiTime2,tzone="Europe/Paris")
print(ParisLouis)
```
...
```{r ans21}
# sumChNumbers
ch1to9 <- c("壹"=1,"貳"=2,"參"=3,"肆"=4,"伍"=5,"陸"=6,"柒"=7,"捌"=8,"玖"=9)
chNumbers <- c(ch1to9, 500, replace = T)
sum(chNumbers)
...
```{r ans22}
# sumChNumbersWith0
ch0to9 <- c("零"=0,"壹"=1,"貳"=2,"參"=3,"肆"=4,"伍"=5,"陸"=6,"柒"=7,"捌"=8,"玖"=9)
chNumbersWith0 <- sample(ch0to9, randomLength, replace=T)
sum(chNumbersWith0)
